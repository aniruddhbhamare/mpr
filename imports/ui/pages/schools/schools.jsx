...
export const SchoolsPageContainer = withTracker(function(props) {
	...
	let schoolListPagedExtraParams = {
		...
		searchFields: Session.get("SchoolListPagedSearchFields") || ["schoolCode", "schoolName", "schoolAddress", "teacherId", "teacher.lastName"],
...
export class SchoolsPageView extends Component {
	...
	componentWillMount() {
		Session.set("SchoolListPagedSearchFields", ["schoolCode", "schoolName", "schoolAddress", "teacherId", "teacher.lastName"]);
	...
	exportData(fileType) {
		...
		let exportFields = ["schoolCode", "schoolName", "schoolAddress", "teacher.lastName"];
