...
export const TeachersPageContainer = withTracker(function(props) {
	...
	let teacherListPagedExtraParams = {
		...
		searchFields: Session.get("TeacherListPagedSearchFields") || ["lastName", "firstName", "email"],
...
export class TeachersPageView extends Component {
	...
	componentWillMount() {
		Session.set("TeacherListPagedSearchFields", ["lastName", "firstName", "email"]);
	...
	exportData(fileType) {
		...
		let exportFields = ["lastName", "firstName", "email"];
