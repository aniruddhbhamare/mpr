...
export const ClassroomsPageContainer = withTracker(function(props) {
	...
	let classroomListPagedExtraParams = {
		...
		searchFields: Session.get("ClassroomListPagedSearchFields") || ["name", "description", "schoolId", "school.schoolName"],
...
export class ClassroomsPageView extends Component {
	...
	componentWillMount() {
		Session.set("ClassroomListPagedSearchFields", ["name", "description", "schoolId", "school.schoolName"]);
	...
	exportData(fileType) {
		...
		let exportFields = ["name", "description", "school.schoolName"];
